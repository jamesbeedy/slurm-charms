...
class TestCharm(TestCase):
    ...
    def test_get_db_info_invalid_uri(self, mock_get_content, mock_convert):
        """Test the correct exception is thrown when a malformed bd-uri is supplied."""
        secret_id = "test-id"
    ...
    def test_get_db_info_secret_not_found(self):
        """Test the correct exception is thrown and correct charm status is set when the given secret does not exist."""
        self.harness.charm._stored.db_uri_secret_id = "missing-id"
    ...
    def test_get_db_info_model_error(self):
        """Test the correct exception is thrown and correct charm status is set when the given secret does not exist."""
        self.harness.charm._stored.db_uri_secret_id = "unauthorized-id"
    ...
    def test_get_db_info_secret_key_error(self):
        ...
        self.harness.charm._stored.db_uri_secret_id = "secret-id"
